...
def sameCountry(placeId1,placeId2):
    part1 = "http://partners.api.skyscanner.net/apiservices/autosuggest/v1.0/UK/GBP/en-GB/?id="
    part2 = "&apikey=hck01722056005870195080684980065"
    r1 = requests.get(part1 + placeId1 + part2)
    r2 = requests.get(part1 + placeId2 + part2)
    
    return r1.json()["Places"][0]["CountryId"] == r2.json()["Places"][0]["CountryId"]
